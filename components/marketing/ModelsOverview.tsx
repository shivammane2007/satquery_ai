        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {MODEL_STACK.slice(0, 2).map((model) => (
            ...
            >
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-[#888888] font-mono">{model.category}</p>
                  </div>
                  <span className="text-[10px] font-mono text-white bg-[#1c1c1c] border border-[#2e2e2e] px-2 py-0.5 rounded-full">
                    {model.badge}
                  </span>
                </div>
                  ...
                  <ul className="space-y-1.5 text-xs text-[#888888]">
                    {model.purpose.slice(0, 3).map((item, idx) => (
                      <li key={idx} className="flex items-start gap-2">
                        <CheckCircle2 className="w-3.5 h-3.5 text-[#737373] shrink-0 mt-0.5" />
              ...
              <div className="pt-4 border-t border-[#1a1a1a] flex flex-wrap items-center justify-between gap-2 text-[11px] font-mono text-[#525252]">
